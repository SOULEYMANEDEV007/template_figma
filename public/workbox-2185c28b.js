        ...
        get(t, e, s) {
            if (t instanceof IDBTransaction) {
                ...
                if ("objectStoreNames" === e)
                    return t.objectStoreNames || L.get(t);
                if ("store" === e)
    ...
    class H {
        ...
        isResponseCacheable(t) {
            ...
            return (
                ...
                this.j &&
                    e &&
                    (e = Object.keys(this.j).some(
                        e => t.headers.get(e) === this.j[e]
                    )),
                e
            );
        }
        ...
        constructor({ precacheController: t }) {
            ((this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
                const s =
                    ...
                    this.S.getCacheKeyForURL(t.url);
    ...
    class Y extends v {
        ...
        async F(t, e) {
                ...
                });
            {
                ...
                ((n = await e.fetch(
                    new Request(t, {
                        integrity: "no-cors" !== t.mode ? r || s : void 0,
                    })
                )),
                    s &&
                        a &&
        ...
        (t.NetworkFirst = class extends v {
            ...
            async U(t, e) {
                ...
                const o = await e.waitUntil(
                    (async () =>
                        (await e.waitUntil(Promise.race(i))) || (await a))()
                );
